...
import { COMPONENT_SEPARATOR, ESCAPE_CHARACTER, FIELD_SEPARATOR, REPETITION_SEPARATOR, SUBCOMPONENT_SEPARATOR, } from '../constants.js';
export function hl7Escape(value, message) {
    if (value === null)
        return '""';
    if (value == null)
        return '';
    ...
    const subComponentSeparator = message?.subComponentSeparator || SUBCOMPONENT_SEPARATOR;
    const repetitionSeparator = message?.repetitionSeparator || REPETITION_SEPARATOR;
...
export function hl7UnEscape(value, message) {
    if (value === '""')
        return null;
    const fieldSeparator = message?.fieldSeparator || FIELD_SEPARATOR;
    const componentSeparator = message?.componentSeparator || COMPONENT_SEPARATOR;
